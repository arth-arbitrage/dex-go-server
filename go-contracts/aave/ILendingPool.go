...
func (_ILendingPool *ILendingPoolCaller) GetReserves(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
...
//
// Solidity: function getReserves() view returns(address[])
func (_ILendingPool *ILendingPoolSession) GetReserves() ([]common.Address, error) {
...
//
// Solidity: function getReserves() view returns(address[])
func (_ILendingPool *ILendingPoolCallerSession) GetReserves() ([]common.Address, error) {
	return _ILendingPool.Contract.GetReserves(&_ILendingPool.CallOpts)
}
